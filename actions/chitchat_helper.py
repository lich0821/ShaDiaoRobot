...
if __name__ == "__main__":
    import argparse
    from chitchat.seq2seq import Seq2Seq

    parser = argparse.ArgumentParser()
    parser.add_argument("--mode", "-m", type=str, default="serve", help="Train or Serve")
    parser.add_argument("--data_path", "-p", type=str, default="chitchat/dataset/", help="dataset path")
    parser.add_argument("--log_dir", type=str, default="chitchat/logs/", help="dataset path")
    parser.add_argument("--model_data", type=str, default="chitchat/model_data/", help="mode output path")
